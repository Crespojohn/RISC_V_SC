...
set genomeRtd $env(RT_TMP)/80F7AEC0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {block_mem__GB8}]"
...
set genomeName [subst -nocommands -novariables {block_mem__GB8}]
