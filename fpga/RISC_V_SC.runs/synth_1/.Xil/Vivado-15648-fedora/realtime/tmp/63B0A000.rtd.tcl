...
set genomeRtd $env(RT_TMP)/63B0A000.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {block_mem__GB6}]"
...
set genomeName [subst -nocommands -novariables {block_mem__GB6}]
